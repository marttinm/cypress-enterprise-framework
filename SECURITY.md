...
If you discover a security vulnerability, please email [maintainer-email] instead of using the issue tracker.
...
- Dependencies are reviewed on merge
- Security updates are prioritized
- Outdated packages are flagged
- Breaking changes are managed carefully

## Contact

[Email address for security contacts needed]
